...
type InputMessage struct {
	...
	Entry  []InputMessageEntry `json:"entry"`
}

// InputMessageEntry entry for FB webhooks
type InputMessageEntry struct {
	ID      string `json:"id"`
...
// MessagingEntry is entry for FB messenger event
type MessagingEntry struct {
	Sender    Recipient               `json:"sender"`
	Recipient Recipient               `json:"recipient"`
	Timestamp int64                   `json:"timestamp"`
	Message   *MessagingEntryMessage  `json:"message"`
	Referral  *MessagingEntryReferral `json:"referral"`
}

// MessagingEntryMessage message field of MessagingEntry
type MessagingEntryMessage struct {
	Mid  string `json:"mid"`
...
// MessagingEntryReferral referral field of MessagingEntry
type MessagingEntryReferral struct {
	Ref    string `json:"ref"`
